<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href=" " target="_blank">
        <img src="{{asset('assets/admin/img/LOGO-removebg-preview.png')}}" class="navbar-brand-img h-100" alt="main_logo">
        <span class="ms-1 font-weight-bold">Lara Shop</span>
      </a>
    </div>
    ...
    <div class=" w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link {{ (Request::is('admin/AdCategory') || Request::is('admin/AdCategory/create'))  ? 'active' : '' }}" href="{{route('AdCategory.index')}}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
