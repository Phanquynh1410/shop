...
<body class="">
  ...
  <main class="main-content  mt-0">
    <section class="min-vh-100 mb-8">
      <div class="page-header align-items-start min-vh-50 pt-5 pb-11 m-3 border-radius-lg" style="background-image: url({{ asset('assets/admin/img/bg.png') }});" >
              ...
              <div class="row px-xl-5 px-sm-4 px-3">
                <div class="col-3 ms-auto px-1">
                  <a class="btn btn-outline-light w-100" href="javascript:;">
                    <svg style="margin-left: -5px;" width="24px" height="32px" viewBox="0 0 64 64" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink32">
                ...
                <div class="col-3 px-1">
                  <a class="btn btn-outline-light w-100" href="javascript:;">
                    <svg style="margin-left: -5px;"  width="24px" height="32px" viewBox="0 0 64 64" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                      <g id="Artboard" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
              ...
              <div class="card-body">
                <form role="form text-left">
                  ...
                  <div class="text-center">
                    <button type="button" class="btn bg-gradient-dark w-100 my-4 mb-2" style="background-image: linear-gradient(310deg, #7928CA 0%, #FF0080 100%) !important;">Sign up</button>
                  </div>
                  <p class="text-sm mt-3 mb-0">
                    Already have an account? 
                    <a href="javascript:;" class="text-dark font-weight-bolder" style="color: linear-gradient(310deg, #7928CA 0%, #FF0080 100%) !important;" >Sign in</a>
                 </p>
                </form>
              </div>
            </div>
